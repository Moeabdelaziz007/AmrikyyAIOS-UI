...
const TripPlannerApp: React.FC<TripPlannerAppProps> = ({ startTravelWorkflow }) => {
                ...
                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); handleCreateTrip(); }}>
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-black/20 border border-white/10 rounded-md p-3 focus:ring-2 focus:ring-primary-blue focus:outline-none"
                            value={destination}
                    ...
                    <div>
                        <label htmlFor="budget" className="block text-sm font-medium text-text-secondary mb-2">Budget: ${budget}</label>
                        <input 
                            type="range" 
                            id="budget" 
                            min="500" 
                            ...
                            className="w-full h-2 bg-black/20 rounded-lg appearance-none cursor-pointer accent-primary-blue" 
                        />
                    </div>
                    <button type="submit" className="w-full font-bold py-3 px-4 rounded-lg bg-gradient-to-r from-primary-blue to-primary-purple hover:brightness-110 active:scale-95 transition-all duration-200">
                        Create Trip with AI ✨
                    </button>
                </form>
            </div>
